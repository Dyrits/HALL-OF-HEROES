...
function getStats(strength, perception, endurance, charisma, intelligence, agility, luck) {
    return { strength, perception, endurance, intelligence, agility, luck };
}
